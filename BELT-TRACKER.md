# Claude Code Mastery — Belt Tracker

> From Blue Belt to Black Belt. Track progress, sidetrack when needed, come back and finish.

## The Journey

```
⬜ White Belt    — Installed, can chat                           ✅ DONE
...
| # | Topic | Status | Notes |
|---|-------|--------|-------|
| 1 | Plan Mode — when/why/how | ✅ | `concepts/PLAN-MODE-THE-WAR-ROOM.md` + strategy in minihub |
...
## ⬛ Black Belt — Battle-Tested (Hands-On in Minihub)

> These unlock ONLY through real work. Check them off as you use each in minihubvone/hub-insights.

| # | Challenge | Status | Where |
|---|-----------|--------|-------|
| 1 | Use plan mode on a real feature | ⬜ | Chat tool architecture |
| 2 | Use interview pattern for feature spec | ⬜ | AI chat BRD refinement |
| 3 | Use test-first pattern on a tool | ⬜ | search_member tool |
| 4 | Hit context limits and manage through it | ⬜ | Long implementation session |
| 5 | Use /batch on a real migration | ⬜ | Soft-delete filters across queries |
| 6 | Use security-reviewer agent on a real PR | ⬜ | Chat tool PR review |
| 7 | Use subagents for codebase investigation | ⬜ | Explore auth flow, DynamoDB patterns |
| 8 | Use worktree for parallel features | ⬜ | Chat + another feature simultaneously |
| 9 | Use /rewind to recover from a wrong path | ⬜ | Will happen naturally |
| 10 | Use keybinding chords without thinking | ⬜ | Muscle memory |
